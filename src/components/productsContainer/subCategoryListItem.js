...
function subCategoryListItem(props){
    ...
    return(
        <>
            <li  className={props.currSubCategory==props.subCategory.subCategory? "products-container__category--active display-flex" : "products-container__category--inactive display-flex" } onClick={()=>props.subCategoryClick(props.subCategory.subCategory)}>
